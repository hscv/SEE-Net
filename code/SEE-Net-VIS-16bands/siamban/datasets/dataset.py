...
class SubDataset(object):
    ...
    def get_image_anno(self, video, track, frame):
        frame = "{:06d}".format(frame)
        lastFileName = video[-4:]+'.x.npy'
        image_path = os.path.join(self.root, video[:video.rfind('/')],
                                  lastFileName)
        image_anno = self.labels[video][track][frame]
        return image_path, image_anno
...
class BANDataset(Dataset):
    def __init__(self,):
        ...
        for name in cfg.DATASET.NAMES:
            ...
            subdata_cfg.ANNO = '/nas_data/lizf/TIP/TIP_first_submit_202110/coco/trainHSI_NJUST.json'
            subdata_cfg.ROOT = '/nas_data/lizf/TIP/TIP_first_submit_202110/coco/crop511/'
